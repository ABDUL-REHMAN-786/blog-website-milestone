    ...
    <section className="w-full overflow-hidden">
      <div className="mx-auto flex px-5 py-10 md:flex-row flex-col items-center">
        ...
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col items-start text-left mb-16 md:mb-0">
          <h1 className="font-inter sm:text-[40px] text-[30px] mb-4 mt-10 md:mt-0 font-medium text-red-700 underline">
            About Me
          </h1>
      ...
      <div className="py-12 px-6">
        <h2 className="text-center font-inter sm:text-[40px] text-[30px] mb-6 font-medium text-red-700 underline">
          Expertise
        </h2>
